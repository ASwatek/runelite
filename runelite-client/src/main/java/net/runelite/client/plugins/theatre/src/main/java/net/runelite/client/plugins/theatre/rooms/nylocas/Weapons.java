...
public enum Weapons
{
	MELEE(Set.of(ItemID.ABYSSAL_WHIP, ItemID.ABYSSAL_TENTACLE, ItemID.SCYTHE_OF_VITUR,
		...
		Set.of(ComparableEntries.newBaseComparableEntry("Attack", "Nylocas Hagios"),
			ComparableEntries.newBaseComparableEntry("Attack", "Nylocas Toxobolos"))
	),
	MAGE(Set.of(ItemID.KODAI_WAND, ItemID.MASTER_WAND, ItemID.TRIDENT_OF_THE_SEAS,
		...
		Set.of(ComparableEntries.newBaseComparableEntry("Attack", "Nylocas Ischyros"),
			ComparableEntries.newBaseComparableEntry("Attack", "Nylocas Toxobolos"))
	),
	RANGE(Set.of(ItemID.TOXIC_BLOWPIPE, ItemID.TWISTED_BOW, ItemID.CRAWS_BOW,
