...
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.RoomHandler;
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.TheatreConfig;
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.TheatreConstant;
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.TheatrePlugin;
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.TheatreRoom;

@Slf4j
public class MaidenHandler extends RoomHandler
{
	private static final Set<WorldPoint> N1 = Set.of(
		new WorldPoint(3182, 4457, 0),
		new WorldPoint(3174, 4457, 0)
	);
	private static final Set<WorldPoint> N2 = Set.of(
		new WorldPoint(3178, 4457, 0),
		new WorldPoint(3186, 4455, 0),
		new WorldPoint(3186, 4457, 0)
	);
	private static final Set<WorldPoint> S1 =  Set.of(
		new WorldPoint(3174, 4437, 0),
		new WorldPoint(3182, 4437, 0)
	);
	private static final Set<WorldPoint> S2 = Set.of(
		new WorldPoint(3186, 4439, 0),
		new WorldPoint(3186, 4437, 0),
		new WorldPoint(3178, 4437, 0)
	);
	private static final Set<Integer> FREEZEANIMS = Set.of(
		361,
		363,
		367,
		369
	...
	private int ticksTilNextAttack = 10;
	...
	public void render(Graphics2D graphics)
	{
		...
		if (config.showMaidenAttackTicks() && this.maiden != null)
		{
			if (this.ticksTilNextAttack > 0)
			{
				final String ticksLeftStr = String.valueOf(this.ticksTilNextAttack);
				Point canvasPoint = this.maiden.getCanvasTextLocation(graphics, ticksLeftStr, 130);
				renderTextLocation(graphics, ticksLeftStr, 20, Font.BOLD, Color.CYAN, canvasPoint);
			}
	...
	public void onAnimationChanged(AnimationChanged event)
	{
		...
		if (this.maiden != null && id == this.maiden.getId())
		{
			if (animation == TheatreConstant.MAIDEN_ATTACK1 || animation == TheatreConstant.MAIDEN_ATTACK2)
			{
				this.ticksTilNextAttack = 11;
			}
		}
	}
