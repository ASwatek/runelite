...
package net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre;
...
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.rooms.BloatHandler;
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.rooms.MaidenHandler;
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.rooms.SotetsegHandler;
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.rooms.VerzikHandler;
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.rooms.nylocas.NyloHandler;
import net.runelite.client.plugins.theatre.src.main.java.net.runelite.client.plugins.theatre.rooms.xarpus.XarpusHandler;
...
public class TheatrePlugin extends Plugin
{
	...
	private void onAnimationChanged(AnimationChanged event)
	{
		...
		{
			maidenHandler.onAnimationChanged(event);
		}
	}
	...
	private void onNpcDespawned(NpcDespawned event)
	{
		...
		if (verzikHandler != null)
		{
			verzikHandler.onNpcDespawned(event);
		}
	}
	...
	private void onProjectileSpawned(ProjectileSpawned event)
	{
		...
		if (xarpusHandler != null)
		{
			xarpusHandler.onProjectileSpawned(event);
		}
	}
